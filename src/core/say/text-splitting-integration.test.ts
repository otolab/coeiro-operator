...
describe('テキスト分割モード統合テスト', () => {
    ...
    describe('固定サイズ分割モード', () => {
        test('small分割（30文字、3文字オーバーラップ）の動作確認', async () => {
            const longText = 'これは30文字を超える長いテキストです。小分割モードでの処理を確認するためのテストテキストです。';
        ...
        test('medium分割（50文字、5文字オーバーラップ）の動作確認', async () => {
            const longText = 'これは50文字を大きく超える非常に長いテキストです。中分割モードでの処理を確認するためのテストテキストです。文章を複数含んでいて分割効果を測定します。';
        ...
        test('large分割（100文字、10文字オーバーラップ）の動作確認', async () => {
            const longText = 'これは100文字を大幅に超える極めて長いテキストです。'.repeat(3) + 
    ...
    describe('none分割モード（分割なし）', () => {
        test('長文でも分割せずに一括処理されること', async () => {
            const longText = 'これは非常に長い文章です。'.repeat(20) + 
    ...
    describe('分割モード比較とパフォーマンス', () => {
        test('各分割モードでのレスポンス時間比較', async () => {
            const testText = 'パフォーマンステスト用の文章です。'.repeat(5) + 
