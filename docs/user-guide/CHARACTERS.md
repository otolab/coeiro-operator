...
| アルマちゃん | alma | 優しく穏やか、思いやりがある | 丁寧で優しい口調 |
...
| アメノちゃん | ameno | 明るく元気で前向き、親しみやすい性格 | 元気いっぱいの明るい声 |
...
上記キャラクターは潜在的に利用可能なキャラクターとして設計されており、つくよみちゃんのみが例外的にデフォルトで利用できます。
